...
public class ExcelUtil {
	...
	public ExcelUtil(FileInputStream is, String version)  throws FileNotFoundException, IOException {
	...
	public String toString(int sheetIx) throws IOException {
		...
		return "第 " + (sheetIx + 1) + "个sheet 页，名称： " + getSheetName(sheetIx)
	 ...
	 * @throws Exception
	 */
	public ArrayList<ArrayList<String>> read(int sheetIx) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ArrayList<ArrayList<String>> read(int sheetIx, int start, int end)
			throws Exception {
	 ...
	 * 
	 */
	public boolean write(ArrayList<ArrayList<String>> rowData) throws IOException {
	 ...
	 * @throws IOException
	 */
	public boolean write(ArrayList<ArrayList<String>> rowData, String sheetName,
	 ...
	 * @throws IOException
	 */
	public boolean write(int sheetIx, ArrayList<ArrayList<String>> rowData,
	 ...
	 * @throws IOException
	 */
	public boolean write(int sheetIx, ArrayList<ArrayList<String>> rowData, int startRow)
			throws IOException {
		Sheet sheet = workbook.getSheetAt(sheetIx);
	 ...
	 * @throws IOException
	 */
	public boolean setStyle(int sheetIx, int rowIndex, int colIndex,
			CellStyle style) throws IOException {
		Sheet sheet = workbook.getSheetAt(sheetIx);
